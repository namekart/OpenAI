      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <button className="text-sm font-medium bg-primary hover:bg-primary/90 text-white px-5 py-2 rounded-full shadow-[0_0_15px_rgba(59,130,246,0.3)] hover:shadow-[0_0_25px_rgba(59,130,246,0.5)] transition-all">
              Request Demo
            </button>
          </div>
          ...
          >
            <div className="px-4 pt-2 pb-6 space-y-1">
              ...
              <div className="pt-4 flex flex-col gap-3">
                <button className="w-full text-center text-base font-medium bg-primary text-white px-4 py-3 rounded-xl shadow-lg shadow-primary/20 transition-all">
                  Request Demo
                </button>
              </div>
            </div>
