        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-teal-500 hover:bg-teal-400 text-black font-semibold" onClick={() => {}}>
                Schedule a Demo
              </Button>
              <Button size="lg" variant="outline" className="border-teal-500/30 hover:border-teal-500/60" onClick={() => {}}>
                Learn More
              </Button>
            </div>
          </div>
